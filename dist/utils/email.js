...
module.exports = {
  ...
  send: function send(type, to, detail) {
    ...
    var content = new _sendgrid2.default.mail.Content('text/plain', this.getContent(type, detail));
   ...
   */
  getContent: function getContent(type, detail) {
    var content = '';
    if (type === 'registration') {
      ...
      content = 'Hello friend, this is a test';
    }
    return content;
  },
